...
OUTPUT="bench/results/ablation_qwen35_instruct_fp8_300.jsonl"
...
systemd-run --user --unit=qwen35-ablation --remain-after-exit \
  ...
  -- "$PYTHON" bench/eval/ablation.py \
    ...
    --api-key EMPTY \
    --instance-ids django__django-13315 django__django-13321 django__django-13401 django__django-13447 django__django-13448 \
    --levels 0 1 2 3 4 \
    --output "$OUTPUT"
