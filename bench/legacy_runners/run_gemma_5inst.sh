...
OUTPUT_DIR="bench/data/eval_results_gemma_5inst"
...
echo "=== Launching 5-Instance Ablation Subset ==="
$VLLM_PYTHON bench/eval/ablation.py \
  --model "openai/$MODEL" \
  --api-base "http://localhost:$PORT/v1" \
  --api-key "sk-no-key-required" \
  --instance-ids astropy__astropy-12907 django__django-11099 sympy__sympy-20590 pytest-dev__pytest-5221 scikit-learn__scikit-learn-10297 \
  --levels 0 1 2 3 4 \
  --output "$OUTPUT_DIR/results.jsonl"

echo "5-Instance test completed successfully!"
